...
namespace MHMS.Class_Efficiency
{
    class LossRate_Class
    {
        ...
        //------------------------------------------------------
        public string Loss_Section { get; set; }
        public string Loss_Item { get; set; }
        public string Loss_DailyResult { get; set; }
        public string Loss_OverallResult { get; set; }
        public string Loss_Month { get; set; }
